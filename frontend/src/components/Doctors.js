...
import { Calendar, Clock, FileText, User, Users, ChevronDown, Home, UserCircle, Calendar as CalendarIcon, Eye, EyeOff, Stethoscope } from 'lucide-react';
...
export default function DoctorDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-teal-950 to-blue-950">
      <header className="border-b border-teal-300/15 bg-gradient-to-r from-slate-950 via-teal-950 to-blue-950 p-4 flex justify-between items-center text-white">
